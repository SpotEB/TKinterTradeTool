...
# Load the JSON file
with open("TkinterTradeTool/db/merged_inventory.json", "r", encoding="utf-8") as file:
    data = json.load(file)
...
with open("TkinterTradeTool/db/merged_inventory_final.json", "w", encoding="utf-8") as file:
